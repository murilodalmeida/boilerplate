...
public sealed class CommentEntityConfiguration : BaseEntityConfiguration<Guid, CommentEntity>, ITypeConfiguration
{
    public override void Extend(EntityTypeBuilder<CommentEntity> builder)
    {
        builder
